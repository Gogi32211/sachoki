...
const SIG_GROUPS = [
  ...
  { divider: true },
  // ── WLNBB / L-signals ─────────────────────────────────────────────────
  // OR shortcuts (∗ = any in family, | = cross-family OR)
  { key: '_fri_any',  label: 'FRI∗',  cls: 'text-cyan-200',
    custom: r => r.fri34 || r.fri43 || r.fri64 },
  { key: '_l_any',    label: 'L∗',    cls: 'text-blue-200',
    custom: r => r.l34 || r.l43 || r.l64 || r.l22 || r.l555 },
  { key: '_be_any',   label: 'BE∗',   cls: 'text-emerald-200',
    custom: r => r.be_up || r.be_dn },
  { key: '_bo_any',   label: 'BO∗',   cls: 'text-lime-200',
    custom: r => r.bo_up || r.bo_dn },
  { key: '_bx_any',   label: 'BX∗',   cls: 'text-lime-200',
    custom: r => r.bx_up || r.bx_dn },
  { key: '_l_or_be',  label: 'L|BE',  cls: 'text-teal-200 font-semibold',
    custom: r => r.l34 || r.l43 || r.l64 || r.be_up || r.be_dn },
  { divider: true },
