...
OFFERED = [
    ...
    ("phys_r", "R · Ohm (RF/RN/RA)"),
    ("phys_regime", "regime (U/D)"),
    ("phys_c", "C · Coulomb (C0/C1/C2)"),
    ("phys_h", "H · entropy (H0/H1/H2)"),
    ("phys_line6", "line 6 composite (R·regime·C·H)"),
    ("phys_m", "M · momentum (M0/M1/M2)"),
    ("phys_e", "E · spring energy (E0/E1/E2 ★)"),
    ("phys_k", "K · Hooke stretch (K0/K1/K2 U/D)"),
    ("phys_s", "S · resonance (S0..S3 U/D)"),
    ("phys_gap_true", "gap TRUE (corrected)"),
    ("phys_ad", "AD-FRESH (★/★★/★A)"),
    ("phys_wyc", "Wyckoff phase"),
    ("sector", "sector"),
    ("universe", "universe"),
]
